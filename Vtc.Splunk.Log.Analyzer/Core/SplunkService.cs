...
public class SplunkService
{
    ...
    public async Task<JArray> SearchLogs(string query, DateTime startTime, DateTime endTime, int timeoutSeconds = 30)
    {
        _logger.LogInformation($"Starting Splunk search for query: '{query}' from {startTime} to {endTime}");
        ...
        var splunkQuery = $"search {query} earliest=\"{startTime:MM/dd/yyyy:HH:mm:ss}\" latest=\"{endTime:MM/dd/yyyy:HH:mm:ss}\"";
